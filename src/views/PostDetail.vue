...
import { GlobalDataProps, PostProps, UserProps, ImageProps } from "../store";
import { ResponseType } from "../views/Home.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    const currentPost = computed<PostProps>(() => {
      // console.log(store.getters.getCurrentPost(currentId));
